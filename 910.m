...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% 放大的区域zoom-in interesting two regions of figure; you may change them
% 放大的区域位置信息
location1                = [10 20 10 30];  %default: data6: [10 50 1 60]; data7:[140 180 5 60]
...
I_BDSD = BDSD(I_MS,I_PAN,ratio,siWFze(I_MS,1),sensor);
...
%titleImages = {'GT','EXP','PCA','IHS','Brovey','GS', };
